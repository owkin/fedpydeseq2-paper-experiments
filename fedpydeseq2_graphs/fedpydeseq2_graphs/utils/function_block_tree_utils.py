...
from fedpydeseq2_graphs.utils.data_classes import IterationBlock
from fedpydeseq2_graphs.utils.data_classes import LeafFunctionBlock
...
def recursive_parse(content: str) -> list[dict[str, Any]]:
    ...
    for line in content.splitlines():
        if "<bloc>" in line:
            ...
            assert "</remote>" in line or "</remote_data>" in line, (
...
def build_function_blocks(
    ...
    """Build function blocks from all components.

    The components are the parsed blocks, remote functions,
    iteration blocks.
